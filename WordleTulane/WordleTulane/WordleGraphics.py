...
graphical display for the Wordle project. Don't change this.
"""
...
class WordleGWindow:
    ...
    def set_key_color(self, ch, color):
        try:
            ...
            print(f"KeyError: you tried to set a color for {ch} but there is no such key. Notice that the keys on the keyboard are all capital letters!")
